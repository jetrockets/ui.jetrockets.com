class Ui::Header::Component < ApplicationComponent
  ...
  def classes
    class_names(
      "flex gap-y-2 gap-x-8 lg:gap-x-16 mb-4 md:py-6",
      direction_class,
      align_class,
      justify_class,
      { "lg:sticky lg:z-30 lg:top-navbar bg-white/90 backdrop-blur-xs": @sticky },
      { "pb-4 border-b border-gray-200": @bordered },
