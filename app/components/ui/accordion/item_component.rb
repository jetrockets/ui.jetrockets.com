class Ui::Accordion::ItemComponent < ApplicationComponent
  ...
  erb_template <<~ERB
    <button type="button" class="accordion__header" data-accordion-target="trigger" data-accordion-id="<%= @id %>" aria-expanded="<%= @opened %>">
      ...
      <svg width="20px" data-accordion-icon class="transition-transform duration-300 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
