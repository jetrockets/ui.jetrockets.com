...
function loadAllComponents() {
  ...
  componentsCache = /* @__PURE__ */ new Map();
  slotsCache = /* @__PURE__ */ new Map();
...
var UICompletionProvider = class {
  ...
  buildComponentSnippet(component) {
    ...
    const takesText = component.content?.description?.toLowerCase().includes("text") || component.usage?.includes("ui." + component.name + ' "');
